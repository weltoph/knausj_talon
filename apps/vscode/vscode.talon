...
please execute command [<user.text>]:
    user.vscode("workbench.action.showCommands")
    insert(user.text or "")

please run all tests: user.vscode("testing.runAll")
#
## Sidebar
...
file save: user.vscode("workbench.action.files.saveWithoutFormatting")
#
## Language Features
